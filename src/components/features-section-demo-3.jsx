...
export default function FeaturesSectionDemo() {
  const features = [
    {
      title: "Hi, I'm Aditya Raghav",
      description:
        "I am a tech enthusiast who loves coding and building web applications. and I am a pro at every video game.",
    ...
    },
    {
      title: "This is me",
      description:
        "Me and some of my precios moments.",
    ...
    },
    {
      ...
      description:
        "I love coding and I am open to work in collaboration",
    ...
    },
    {
      title: "Time Zone",
      description:
        "I am based in Gurgaon Haryana, India. I love connecting with people from different parts of the world and collaborating on exciting projects.",
...
export const SkeletonThree = () => {
  return (
    <div className="text-white w-full h-full flex items-center justify-center">
      <button className="relative px-6 py-3 font-semibold border-2 border-white overflow-hidden group rounded-full cursor-pointer">
        <span className="absolute inset-0 bg-white -translate-x-full group-hover:translate-x-0 transition-transform duration-200 "></span>
